...
class abercrombie_holmiun_page(Page):
...
class abercrombie_automation():
    ...
    def get_job_detail(self,url):
        self.page = abercrombie_holmiun_page(self.driver, url)
        time.sleep(1)
...
if __name__ == '__main__':
    url = 'https://abercrombie.taleo.net/careersection/1.0/jobsearch.ftl'
    ...
    au = abercrombie_automation(driver)
