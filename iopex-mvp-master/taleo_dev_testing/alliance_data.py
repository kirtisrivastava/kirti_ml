...
class alliance_holmiun_page(Page):
...
class alliance_automation():
    ...
    def get_job_detail(self,url):
        self.page = alliance_holmiun_page(self.driver, url)
        time.sleep(1)
...
if __name__ == '__main__':
    url = 'https://alliancedata.taleo.net/careersection/alliancedata/jobsearch.ftl?lang=en'
