...
class caterpillar_holmiun_page(Page):
...
class caterpillar_automation():
    ...
    def get_job_detail(self,url):
        self.page = caterpillar_holmiun_page(self.driver, url)
        time.sleep(1)
...
if __name__ == '__main__':
    url = 'https://caterpillar.taleo.net/careersection/cat+external+cs/jobsearch.ftl'
    ...
    au = caterpillar_automation(driver)
