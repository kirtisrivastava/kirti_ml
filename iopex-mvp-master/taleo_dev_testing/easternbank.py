...
class easternbank_holmiun_page(Page):
...
class easternbank_automation():
    ...
    def get_job_detail(self,url):
        self.page = easternbank_holmiun_page(self.driver, url)
        time.sleep(1)
        ...
        time.sleep(2)
        print(len(self.page.job_elements))
       ...
       # self.scrollElementIntoView(self.page.job_elements[0])
        ...
        print(len(self.page.job_details))
...
if __name__ == '__main__':
    url = 'https://easternbank.taleo.net/careersection/ex/jobsearch.ftl'
    ...
    au = easternbank_automation(driver)
