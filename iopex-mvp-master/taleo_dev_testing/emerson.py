...
class emerson_holmiun_page(Page):
...
class emerson_automation():
    ...
    def get_job_detail(self,url):
        self.page = emerson_holmiun_page(self.driver, url)
        time.sleep(1)
...
if __name__ == '__main__':
    url = 'https://emerson.taleo.net/careersection/ex/jobsearch.ftl?lang=en'
