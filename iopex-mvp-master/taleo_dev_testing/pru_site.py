...
class pru_automation():
    ...
    def get_job_detail(self,url):
        self.page = pru_holmiun_page(self.driver, url)
        time.sleep(1)
...
if __name__ == '__main__':
    url = 'https://pru.taleo.net/careersection/2/jobsearch.ftl'
